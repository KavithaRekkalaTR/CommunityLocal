(function ($) {
        ...
        context.fields.graphContainer.fadeTo(fadeDuration, 0.25, function () {
            $.telligent.evolution.get({ timeout: 90000,
                ...
                success: function (response) {
                    ...
                    var options = $.telligent.evolution.widgets.reporting.reportutil.getTileGraphOptions(context, '#6B5B95', 'Number of active groups', data, stringdata);
    ...
    $.telligent.reporting.widgets.activeGroupsTileReport = api;
})(jQuery);