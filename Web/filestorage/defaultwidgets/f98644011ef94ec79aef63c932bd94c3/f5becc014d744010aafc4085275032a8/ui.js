(function ($, global) {
    ...
    function subscribeToFilterMessages(context) {
        ...
        $.telligent.evolution.widgets.reporting.reportutil.subscribeToSearchFlagsFilterChange(context, context.tabNameSpace, filterChanged);
    };
    ...
    var api = {
        register: function (context) {
            ...
            context.localFilters.sortBy = 'SearchCount';
            ...
            context.filters.selectedSearchFlags = tabData.selectedSearchFlags;
    ...
    $.telligent.reporting.widgets.noResultSearchesReport = api;
