(function ($) {
    ...
    function setVisibility(context) {
        if (context.filters.selectedApplications != undefined && context.filters.selectedApplications.length > 0) {
            ...
            showError(context, context.resources.noCalendarError);
        }
    };
            ...
            $.telligent.evolution.get({
                ...
                success: function (response) {
                    ...
                    if (r.find('.error').length > 0) {
                        ...
                        var calendarDataContainer = $('.calendar-data', context.fields.reportContainer);
                        var calendarData = $('.calendar-data', r);
                        if (calendarData.length > 0 && calendarDataContainer.length > 0) {
                            calendarDataContainer.replaceWith(calendarData);
                        }
    ...
    $.telligent.reporting.widgets.calendarSummaryReport = api;
})(jQuery);