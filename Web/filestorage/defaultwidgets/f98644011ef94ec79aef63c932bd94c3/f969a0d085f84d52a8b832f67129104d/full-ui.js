(function ($) {
        ...
        context.fields.graphContainer.fadeTo(fadeDuration, 0.25, function () {
            $.telligent.evolution.post({ timeout: 90000,
                ...
                success: function (response) {
                    ...
                    var options = $.telligent.evolution.widgets.reporting.reportutil.getStandardGraphOptions(context, '#7d9e48', 'Active Members', 'Number of active members', stringdata, resetFilter, graphClick);
    ...
    $.telligent.reporting.widgets.activeUsersReport = api;
})(jQuery);