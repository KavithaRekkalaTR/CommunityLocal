(function ($) {
    ...
    function setVisibility(context) {
        if (context.filters.selectedApplications != undefined && context.filters.selectedApplications.length > 0) {
            ...
            showError(context, context.resources.noIdeationError);
        }
    };
            ...
            $.telligent.evolution.get({
                ...
                success: function (response) {
                    ...
                    if (r.find('.error').length > 0) {
                        ...
                        var ideationDataContainer = $('.ideation-data', context.fields.reportContainer);
                        var ideationData = $('.ideation-data', r);
                        if (ideationData.length > 0 && ideationDataContainer.length > 0) {
                            ideationDataContainer.replaceWith(ideationData);
                        }
    ...
    $.telligent.reporting.widgets.ideationSummaryReport = api;
})(jQuery);