(function ($) {
            ...
            context.fields.graphContainer.fadeTo(fadeDuration, 0.25, function () {
                $.telligent.evolution.post({ timeout: 90000,
                    ...
                    success: function (response) {
                        ...
                        var options = $.telligent.evolution.widgets.reporting.reportutil.getStandardGraphOptions(context, '#3F729B', 'Content', 'Number of created content', stringdata, resetFilter, graphClick);
        ...
        context.fields.graphContainer.fadeTo(fadeDuration, 0.25, function () {
            $.telligent.evolution.post({ timeout: 90000,
                ...
                success: function (response) {
                    ...
                    var options = $.telligent.evolution.widgets.reporting.reportutil.getMultiLineGraphOptions(context, 'Content by Type', 'Number of content', byTypeGraphClick, resetFilter, showSeries, hideSeries);
    ...
    var api = {
        register: function (context) {
            ...
            context.localFilters.sortBy = 'CreatedDate';
    ...
    $.telligent.reporting.widgets.contentContributionsReport = api;
})(jQuery);