(function ($) {
            ...
            context.fields.graphContainer.fadeTo(fadeDuration, 0.25, function () {
                $.telligent.evolution.post({ timeout: 90000,
                    ...
                    success: function (response) {
                        ...
                        var options = $.telligent.evolution.widgets.reporting.reportutil.getStandardGraphOptions(context, '#3F729B', 'Viewed Content', 'Number of viewed content', stringdata, resetFilter, graphClick);
        ...
        context.fields.graphContainer.fadeTo(fadeDuration, 0.25, function () {
            $.telligent.evolution.post({ timeout: 90000,
                ...
                success: function (response) {
                    ...
                    var options = $.telligent.evolution.widgets.reporting.reportutil.getMultiLineGraphOptions(context, 'Viewed Content', 'Number of viewed content', byTypeGraphClick, resetFilter, showSeries, hideSeries);
    ...
    var api = {
        register: function (context) {
            ...
            context.localFilters.sortBy = 'LastViewed';
    ...
    $.telligent.reporting.widgets.viewedContentReport = api;
})(jQuery);