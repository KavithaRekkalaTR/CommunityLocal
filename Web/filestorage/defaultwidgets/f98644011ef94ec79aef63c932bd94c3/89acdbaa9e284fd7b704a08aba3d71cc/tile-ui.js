(function ($) {
        ...
        context.fields.graphContainer.fadeTo(fadeDuration, 0.25, function () {
            $.telligent.evolution.get({ timeout: 90000,
                ...
                success: function (response) {
                    ...
                    var options = $.telligent.evolution.widgets.reporting.reportutil.getTileGraphOptions(context, '#3F729B', 'Number of active content', data, stringdata);
    ...
    $.telligent.reporting.widgets.activeContentTileReport = api;
})(jQuery);