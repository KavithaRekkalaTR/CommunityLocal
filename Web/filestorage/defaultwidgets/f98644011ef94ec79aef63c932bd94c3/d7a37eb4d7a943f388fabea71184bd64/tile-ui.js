(function ($) {
        ...
        context.fields.graphContainer.fadeTo(fadeDuration, 0.25, function () {
            $.telligent.evolution.get({ timeout: 90000,
                ...
                success: function (response) {
                    ...
                    var options = $.telligent.evolution.widgets.reporting.reportutil.getTileGraphOptions(context, '#7d9e48', 'Number of new members', data, stringdata);
    ...
    $.telligent.reporting.widgets.newUsersTileReport = api;
})(jQuery);