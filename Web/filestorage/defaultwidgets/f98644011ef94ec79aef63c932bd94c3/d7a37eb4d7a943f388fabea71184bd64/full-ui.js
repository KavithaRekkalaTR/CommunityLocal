(function ($) {
        ...
        context.fields.graphContainer.fadeTo(fadeDuration, 0.25, function () {
            $.telligent.evolution.post({ timeout: 90000,
                ...
                success: function (response) {
                    ...
                    var options = $.telligent.evolution.widgets.reporting.reportutil.getStandardGraphOptions(context, '#7d9e48', 'New Members', 'Number of new members', stringdata, resetFilter, graphClick);
    ...
    $.telligent.reporting.widgets.newUsersReport = api;
})(jQuery);