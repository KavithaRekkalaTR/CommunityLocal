(function ($) {
    ...
    function setVisibility(context) {
        if (context.filters.selectedApplications != undefined && context.filters.selectedApplications.length > 0) {
            ...
            showError(context, context.resources.noBlogError);
        }
    };
            ...
            $.telligent.evolution.get({
                ...
                success: function (response) {
                    ...
                    if (r.find('.error').length > 0) {
                        ...
                        var blogDataContainer = $('.blog-data', context.fields.reportContainer);
                        var blogData = $('.blog-data', r);
                        if (blogData.length > 0 && blogDataContainer.length > 0) {
                            blogDataContainer.replaceWith(blogData);
                        }
    ...
    $.telligent.reporting.widgets.blogSummaryReport = api;
})(jQuery);