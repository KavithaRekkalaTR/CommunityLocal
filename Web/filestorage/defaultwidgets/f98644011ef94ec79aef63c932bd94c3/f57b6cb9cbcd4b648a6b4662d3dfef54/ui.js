(function ($, global) {
    ...
    var api = {
        register: function (context) {
            ...
            context.localFilters.sortBy = 'ViewDate';
            ...
            context.filters.selectedGroups = tabData.selectedGroups !== undefined ? tabData.selectedGroups : [];
            ...
            context.filters.selectedApplications = tabData.selectedApplications !== undefined ? tabData.selectedApplications : [];
    ...
    $.telligent.reporting.widgets.viewsReport = api;
