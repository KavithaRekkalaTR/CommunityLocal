(function ($) {
    ...
    function setVisibility(context) {
        if (context.filters.selectedApplications != undefined && context.filters.selectedApplications.length > 0) {
            ...
            showError(context, context.resources.noGalleryError);
        }
    };
            ...
            $.telligent.evolution.get({
                ...
                success: function (response) {
                    ...
                    if (r.find('.error').length > 0) {
                        ...
                        var galleryDataContainer = $('.gallery-data', context.fields.reportContainer);
                        var galleryData = $('.gallery-data', r);
                        if (galleryData.length > 0 && galleryDataContainer.length > 0) {
                            galleryDataContainer.replaceWith(galleryData);
                        }
    ...
    $.telligent.reporting.widgets.gallerySummaryReport = api;
})(jQuery);