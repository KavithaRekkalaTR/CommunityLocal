(function ($) {
    ...
    function setVisibility(context) {
        if (context.filters.selectedApplications != undefined && context.filters.selectedApplications.length > 0) {
            ...
            showError(context, context.resources.noArticleCollectionError);
        }
    };
            ...
            $.telligent.evolution.get({
                ...
                success: function (response) {
                    ...
                    if (r.find('.error').length > 0) {
                        ...
                        var articleDataContainer = $('.article-collection-data', context.fields.reportContainer);
                        var articleData = $('.article-collection-data', r);
                        if (articleData.length > 0 && articleDataContainer.length > 0) {
                            articleDataContainer.replaceWith(articleData);
                        }
    ...
    $.telligent.reporting.widgets.articleCollectionSummaryReport = api;
})(jQuery);