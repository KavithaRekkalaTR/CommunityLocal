(function ($) {
        ...
        context.fields.graphContainer.fadeTo(fadeDuration, 0.25, function () {
            $.telligent.evolution.post({ timeout: 90000,
                ...
                success: function (response) {
                    ...
                    var options = $.telligent.evolution.widgets.reporting.reportutil.getStandardGraphOptions(context, '#6B5B95', 'New Groups', 'Number of new groups', stringdata, resetFilter, graphClick);
    ...
    $.telligent.reporting.widgets.newGroupsReport = api;
})(jQuery);