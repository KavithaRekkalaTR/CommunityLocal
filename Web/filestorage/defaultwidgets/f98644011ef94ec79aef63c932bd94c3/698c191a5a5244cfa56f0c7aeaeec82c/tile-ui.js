(function ($) {
        ...
        context.fields.graphContainer.fadeTo(fadeDuration, 0.25, function () {
            $.telligent.evolution.get({ timeout: 90000,
                ...
                success: function (response) {
                    ...
                    var options = $.telligent.evolution.widgets.reporting.reportutil.getTileGraphOptions(context, '#ff7c4c', 'Number of interactions', data, stringdata);
    ...
    $.telligent.reporting.widgets.interactionsTileReport = api;
})(jQuery);