(function ($) {
        ...
        context.fields.graphContainer.fadeTo(fadeDuration, 0.25, function () {
            $.telligent.evolution.post({ timeout: 90000,
                ...
                success: function (response) {
                    ...
                    var options = $.telligent.evolution.widgets.reporting.reportutil.getMultiLineTileGraphOptions(context, 'Interaction by Type', 'Number of interactions', setEnabledActivityTypes);
    ...
    $.telligent.reporting.widgets.interactionsbyTypeLargeTileReport = api;
})(jQuery);