...
this.actions = context.ListActions({
    ...
    SourceType: core_v2_page.GetQueryStringValue("sourceType"),
    SourceId: core_v2_page.GetQueryStringValue("sourceId"),
    Action: core_v2_page.GetQueryStringValue("action"),
    UserId: core_v2_utility.ParseInt(core_v2_page.GetQueryStringValue("userId")),
