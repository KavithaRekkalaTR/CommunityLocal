...
// requesting the result of import
	...
	return {
		newAutomations: importResult.NewAutomations.Count,
		updatedAutomations: importResult.UpdatedAutomations.Count,
		matchingAutomations: importResult.MatchingAutomations.Count,
		invalidAutomations: importResult.InvalidAutomations.Count,

		newConfiguredAutomations: importResult.NewConfiguredAutomations.Count,
		updatedConfiguredAutomations: importResult.UpdatedConfiguredAutomations.Count,
