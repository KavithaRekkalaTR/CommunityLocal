(function($, global, undef) {
	...
	function deleteComment(context, commentId) {
	...
	var api = {
		register: function(options) {
			...
			$.telligent.evolution.messaging.subscribe('contextual-delete-comment', function(data){
				deleteComment(options, $(data.target).data('commentid'));
			});
	...
	$.telligent.evolution.widgets.blogTrackBacksApplicationPanel = api;
