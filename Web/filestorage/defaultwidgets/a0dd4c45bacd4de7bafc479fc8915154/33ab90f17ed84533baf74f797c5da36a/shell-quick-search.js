define('StudioQuickSearch', function($, global, undef) {
	...
	function init(context) {
		...
		context.searchInput = $(context.searchInput);
	...
	var StudioQuickSearch = function(options) {
		var context = $.extend({}, defaults, options);
		init(context);
	}

	return StudioQuickSearch;
