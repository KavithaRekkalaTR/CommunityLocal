...
var responseTypeId = core_v2_page.GetFormValue('_w_responseTypeId');
var message = core_v2_page.GetFormValue('_w_message');
...
// apply rating
var ratingCreationResponse = articles_v1_helpfulness.NotHelpful(article.Id,responseTypeId, {
	Message: message
});
