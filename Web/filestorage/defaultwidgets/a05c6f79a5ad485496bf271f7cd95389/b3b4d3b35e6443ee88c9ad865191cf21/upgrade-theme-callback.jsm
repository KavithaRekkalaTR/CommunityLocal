...
// schedule a background task with progress to upgrade theme
if (context.UpgradedSocialThemeItemCount > MAX_SYNCHRONOUS_STEPS) {

	var scheduledFileProgressKey = 'upgrade-ui:' + core_v2_user.Accessing.Id;

	core_v2_widget.ScheduleFile('upgrade-theme-task.jsm', {
...
// process brief upgrades synchronously
	...
	var result = context.StageUpgradedSocialTheme();
