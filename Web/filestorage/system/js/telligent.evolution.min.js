...
"normal");a=a.stack[a.currentPanelOffset];if(!a)return b;a=a.renderedNode;if(!a)return b;a.width(b);return b}return null}function J(a,c,e){var f={"shell.closed":C.shellClosed,"shell.navigation.refreshing":C.shellNavigationRefreshing,"shell.navigation.refreshed":C.shellNavigationRefreshed,"panel.unloaded":C.panelUnloaded,"panel.loaded":C.panelLoaded,"panel.shown":C.panelShown,"panel.hidden":C.panelHidden};if(f[c]!==b&&e!==b){var m=v(a,a.currentPanelOffset);d.subscribe(f[c],s(a),function(b){a.sleeping||
(b.panelId?b.panelId===m&&e.call(Q(a).get(0),b):e.call(Q(a).get(0),b))},{excludeAutoNameSpaces:!0})}}function F(a,b){var c=b.find(a.panelHeaderSelector).outerHeight(!0);b.find(a.panelContentSelector).first().css({top:c})}function K(a,b){if(a){var c=a.stack[a.currentPanelOffset].renderedNode;if(c&&b&&b.load){var d=b.load;b.load=function(b){a.stack[a.currentPanelOffset].scrollablePageIndex=b;return d(b).then(function(){return!0})};var f=c.find(a.panelContentSelector).first();b.target||(c=f.find("ul.content-list:visible").filter(function(){return"hidden"!=
e(this).css("visibility")}))&&1==c.length&&(b.target=c);b.initialPageIndex=a.stack[a.currentPanelOffset].scrollablePageIndex||b.initialPageIndex||0;0>b.initialPageIndex&&(b.initialPageIndex=0);b.prefill=b.preFillAttempts||10;e(f).evolutionScrollable(b);return{reset:function(){return e(f).evolutionScrollable("reset")}}}}}function P(a,b){var c=function(b){b=e(b);b.removeClass("expanded");b.find(".expandable-close").remove();b.find(".expandable").each(function(){var b=e(this),c=b.css("display");b.css({display:"none",
height:"auto"});var d=b.height();b.css({display:c,height:d}).evolutionTransform({height:0},{duration:a.transitionDuration/2.5,easing:a.transitionEasing})});b.trigger("collapse")};b.on("click",".content-list.expandable .content-item",function(){var b=e(this);if(!b.hasClass("expanded")){b.closest(".content-list.expandable").find(".content-item.expanded").each(function(){c(this)});b.addClass("expanded");var d=e('<a href="#" class="expandable-close ui-tip" data-tip="'+k.collapseExpandedItem+'"><svg alt="'+
k.collapseExpandedItem+'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="24" height="24"><path d="M10,1.6c-4.639,0-8.4,3.761-8.4,8.4c0,4.639,3.761,8.4,8.4,8.4s8.4-3.761,8.4-8.4C18.4,5.361,14.639,1.6,10,1.6z M14.789,13.061l-1.729,1.729L10,11.729l-3.061,3.06l-1.729-1.729L8.272,10L5.211,6.939L6.94,5.211L10,8.271l3.061-3.061 l1.729,1.729L11.728,10L14.789,13.061z"/></svg></a>');b.prepend(d);b.find(".expandable").each(function(){var b=e(this),c=b.css("display");b.css({display:"none",height:"auto"});
var d=b.height();b.css({display:c,height:0}).evolutionTransform({height:d},{duration:a.transitionDuration/2.5,easing:a.transitionEasing,complete:function(){b.css({height:"auto"})}})});b.trigger("expand")}});b.on("click",".content-list.expandable .content-item.expanded .expandable-close",function(){e(this).closest(".content-item.expanded").each(function(){c(this)});return!1})}function D(a,b){b=e(b);b.data("_handlers_activated")||(b.data("_handlers_activated",!0),P(a,b))}function p(a,b){a.suppressedNameSpaces&&
...
g.each(t,function(b,c){c.init(a)});if(k.top==k){var c=w.get(e);c&&9E4>(new Date).getTime()-c.updated&&g.each(c.notifications,function(a,b){var c=q(b.message,b);v(c)});w.del(e)}}function s(){var a=[];g.each(t,function(b,c){a=a.concat(c.list())});var b=g.extend({},{updated:(new Date).getTime(),notifications:[]},w.get(e)||{});g.each(a,function(a,d){var e=d.duration,f=m(d);d.shownTime&&(e-=b.updated-d.shownTime);1<e&&!(f&&d.shownTime&&!(2>b.updated-d.shownTime)||d&&(d["transient"]||"system-notification"==
d.type||c&&!0===c[d.id]))&&b.notifications.unshift({duration:f?Math.min(e,h.duration):e,width:d.width,mode:d.mode,type:d.type,cssClass:d.cssClass,id:d.id,message:d.message})});0==b.notifications.length?w.del(e):w.set(e,b)}function q(a,c){c&&(!c.duration&&m(c))&&(c.duration=x.errorDuration);var e=g.extend({},h,c||{});e.message=a;e.cssClass=e.type||"";e.id||(e.id=d.guid());null!==b&&g(k).width()<b&&(e.mode="banner");return e}function v(a){var b=a.mode;g.telligent.evolution.administration&&g.telligent.evolution.administration.isAdminShell&&
(b="alert");(b=t[b])&&b.show(a)}var t={},x=a,w;window._persist=s;return{registerRenderer:function(a,b){t[a]=b},init:function(){n();l(x)},show:function(a,b){var c=q(a,b);v(c);return c.id},hide:function(a){a&&g.each(t,function(b,c){c.hide(a)})}}}},jQuery,window);p("module.notifications.unread.icon",function(d,f,g){return function(g){function l(g,q,k){var t="",x="undefined"!=typeof InstallTrigger||!!f.opera||0<=navigator.userAgent.indexOf("Opera");if(h&&!c)if(e=d('head link[rel~="icon"][href]').first(),
0<e.length){c=e.attr("href");b=e.attr("type");try{m=document.createElement("canvas"),a=document.createElement("img"),a.onload=function(){m.height=0<a.height?a.height:32;m.width=0<a.width?a.width:32;n=m.getContext("2d")},d(a).attr({crossOrigin:"anonymous",src:c})}catch(w){h=!1}}else h=!1;if(h)if(n)try{n.clearRect(0,0,m.width,m.height);n.drawImage(a,0,0,m.width,m.height);if(k){if(0<q||0<g)t=Math.max(q,g),99<t&&(t="99+")}else 0<g?(t=g,99<t&&(t="99+")):0<q&&(t="+");if(0===t||""===t)if(x){var r=d('<link type="'+
b+'" rel="icon"></link>');d("head").append(r);r.attr("href",c);e.remove();e=r}else e.attr({href:c,type:b});else{var t=t+"",y=!1,z=0.4*m.width,A=0.4*m.height,B=0.6*m.width,p=0.6*m.height;2===t.length?(z-=0.4*B,B*=1.4,y=!0):3<=t.length&&(z-=0.65*B,B*=1.65,y=!0);n.beginPath();n.font="bold "+Math.floor(p*(2<t.length?0.85:1))+"px sans-serif";n.textAlign="center";y?(n.moveTo(z+B/2,A),n.lineTo(z+B-p/2,A),n.quadraticCurveTo(z+B,A,z+B,A+p/2),n.lineTo(z+B,A+p-p/2),n.quadraticCurveTo(z+B,A+p,z+B-p/2,A+p),n.lineTo(z+
p/2,A+p),n.quadraticCurveTo(z,A+p,z,A+p-p/2),n.lineTo(z,A+p/2),n.quadraticCurveTo(z,A,z+p/2,A)):n.arc(z+B/2,A+p/2,p/2,0,2*Math.PI);n.fillStyle="rgba(221,0,0,1)";n.fill();n.closePath();n.beginPath();n.stroke();n.fillStyle="rgba(255,255,255,1)";n.fillText(t,Math.floor(z+B/2),Math.floor(A+p-0.15*p));n.closePath();x?(r=d('<link type="image/png" rel="icon"></link>'),d("head").append(r),r.attr("href",m.toDataURL("image/png")),e.remove(),e=r):e.attr({href:m.toDataURL("image/png"),type:"image/png"})}}catch(E){h=
!1}else f.clearTimeout(u),u=f.setTimeout(function(){l(g,q,k)},250)}var h=!0,e=null,c=null,b=null,a=null,m=null,n=null,u=null;return{render:function(a){l(a.localUnread,a.globalUnread,a.combineCounts)}}}},jQuery,window);p("module.notifications.unread",["lib.util","module.messaging","lib.sharedObjectProxyState","lib.globalConfiguration","module.rest"],function(d,f,g,k,l,h,e,c){return function(b){function a(){e.clearTimeout(w);var b=!g.hasMultipleWindows();r!=b&&(r=b,u());w=e.setTimeout(function(){a()},
1E3)}function d(){h.telligent.evolution.user&&(h.telligent.evolution.user.accessing&&!h.telligent.evolution.user.accessing.isSystemAccount&&!h.telligent.evolution.user.accessing.isTemporary)&&(e.clearTimeout(y),y=e.setTimeout(function(){l.get({url:k.baseUrl+"api.ashx/v2/notifications.json",cache:!1,data:{IsRead:!1,PageSize:1,PageIndex:0}}).then(function(a){n(a.TotalCount,!1,"notifications")})},1E3))}function n(a,b,c){var d=0;a+="";if("+"==a.substr(0,1)){d=parseInt(a.substr(1),10);if(isNaN(d))return;
...
function(a){var b=parseInt(a.unreadCount,10);isNaN(b)||n(a.unreadCount,!1,"notifications")},{excludeAutoNameSpaces:!0});f.subscribe("notification.raised",function(a){n("+1",!1,"notifications");d()},{excludeAutoNameSpaces:!0})}var q=0,v={},t=0,x={},w=null,r=!0,y=null,z=[],A=!e.parent||e.parent==e;return{registerRenderer:function(a){z.push(a)},init:function(){s();A=A&&!h("body").hasClass("administration");d();a()},unread:function(a,b){if(a===c)return{local:q,global:t};b=b||{};n(a,!0===b.isLocal,b.namespace||
"unknown")}}}},jQuery,window);p("module.notifications.unread.title",function(d,f,g){return function(d){var f=/^(\([0-9\+]+\)\s+)+/;return{render:function(d){var e=document.title.replace(f,"")+"",c=0;if(d.combineCounts){if(0<d.globalUnread||0<d.localUnread)c=Math.max(d.globalUnread,d.localUnread),99<c&&(c="99+"),e="("+c+") "+e}else 0<d.localUnread?(c=d.localUnread,99<c&&(c="99+"),e="("+c+") "+e):0<d.globalUnread&&(e="(+) "+e);document.title=e}}}},jQuery,window);p("lib.crossWindowPresentContentRegistrar",
["lib.storageProxy"],function(d,f,g,k){function l(c){var b={};c=c.split(":");2<=c.length&&(b.ContentId=c[0],b.ContentTypeId=c[1],2<c.length&&(b.TypeId=c[2]));return b}function h(c){g.setInterval(function(){var b=c.storage.get(c.key)||[],a={},d=(new Date).getTime();f.each(b,function(b,e){d-e<c.expiration&&(a[b]=e)});c.storage.set(c.key,a)},c.garbageCollectInterval)}var e={key:"__cwpcr",expiration:4E3,garbageCollectInterval:3E4,user:{}};return function(c){var b=f.extend({},e,c||{});b.storage=new d(b.user);
h(b);return{setVisibleContents:function(a){if(a){for(var c=b.storage.get(b.key)||[],d=(new Date).getTime(),e=0;e<a.length;e++)c[a[e].ContentId+":"+a[e].ContentTypeId+":"+(a[e].TypeId||"")]=d;b.storage.set(b.key,c)}},getUniqueVisibleContent:function(){var a=b.storage.get(b.key)||[],c=[],d=(new Date).getTime();f.each(a,function(a,e){d-e<b.expiration&&c.push(l(a))});return c}}}},jQuery,window);p("lib.crossWindowPresentContentRegistrarSingleton",["lib.crossWindowPresentContentRegistrar"],function(d,f,
g,k){var l=null;return{get:function(g){return l?l:l=new d(f.extend({user:f.telligent.evolution.user.accessing,expiration:4E3},g||{}))}}},jQuery,window);p("module.presence",["lib.crossWindowPresentContentRegistrarSingleton","lib.crossWindowBus","lib.util"],function(d,f,g,k,l,h){function e(c){c=[];for(var d=a.length;d--;)if(0<a[d].node.closest("body").length){var e;(e=a[d].isRoot)||(e=a[d].node.get(0).getBoundingClientRect(),e=(0<e.height||0<e.width)&&0<=e.bottom&&0<=e.right&&e.top<=(l.innerHeight||
document.documentElement.clientHeight)&&e.left<=(l.innerWidth||document.documentElement.clientWidth));if(e)for(e=0;e<a[d].contents.length;e++)c.push({ContentId:a[d].contents[e].ContentId,ContentTypeId:a[d].contents[e].ContentTypeId,TypeId:a[d].contents[e].TypeId})}else a.splice(d,1);0<c.length&&b&&b.setVisibleContents(c)}function c(){b=d.get();l.setInterval(function(){e(!1)},2E3);n=g.debounce(function(){e(!0)},250);u=g.debounce(function(){try{k.telligent.evolution.sockets.present()}catch(a){}},500);
...
else return H.init.apply(this,arguments)};l.fn.evolutionHtmlEditor.defaults={width:"100%",height:"300px",contentTypeId:null,applicationTypeId:null,applicationId:null,enterToSubmitPrompt:null,submitLabel:null,beforeSubmitHtml:null,afterSubmitHtml:null,autoResize:!1,enableEnterToSubmitToggle:!1,placeholder:null,submittable:!1,enableFileUpload:null,_tokens:{}};return{configure:function(a){l.extend(p,a)}}},jQuery,window);p("plugin.evolutionInlineTagEditor",function(d,f,g){var k={},l=function(c,b){if(c.internal.isInitialized){for(var a=
b.split(/[,;]/g),e=[],f=0;f<a.length;f++){var g=d.trim(a[f]);g&&(e[e.length]=g)}c.settings.onSave(e,function(){c.settings.currentTags=e})}},h=function(c){return this.each(function(){var b={settings:d.extend({},d.fn.evolutionInlineTagEditor.defaults,c||{}),internal:{state:d(this)}};d(this).data("evolutionTagInlineEditor_context",b);d(this).html()||d(this).text(b.settings.editButtonText);e(b)})},e=function(c){var b=d("<div></div>").addClass(c.settings.editorCssClass).attr("style","display: none;"),
a=d('<label for="tag-area"></label>').hide(),e=d('<textarea id="tag-area"></textarea>').attr("cols","40").attr("rows","2");if(c.settings.allTags&&0<c.settings.allTags.length)var f=d('<input type="button" />').val(c.settings.selectTagsText);var g=d('<input type="button" />').val(c.settings.saveTagsText),h=d('<input type="button" />').val(c.settings.cancelText),k=d('<div style="white-space: nowrap; padding-top: 4px;"><table width="100%" cellspacing="0" cellpadding="0" border="0"><tbody><td align="left"></td><td align="right"></td></tr></tbody></table></div>');
...
!isNaN(a)&&0==a%c},message:function(b,c){return x(c||a.step,b)},cache:!0};k.url={isValid:function(b,c,e){return!v(b)||b.match(a.urlRegex)?!0:("http://"+b).match(a.urlRegex)?(d(c).val("http://"+b),!0):!1},message:function(b,c){return c||a.url},cache:!0};k.username={isValid:function(b,c,d){return!v(b)||null!=b.match(a.usernameRegex)},message:function(b,c){return c||a.username},cache:!0};k.usernameexists={isValid:function(a,b,c){return d.Deferred(function(b){if(v(a)){c="string"==typeof c&&{url:c}||c;
...
a.internal.customValidations[b].isValid=null;for(b=0;b<a.internal.fields.length;b++)d(a.internal.fields[b].messageSelector).hide(),a.internal.fields[b].errorMessage=null,a.internal.fields[b].isValid=null,a.internal.fields[b].lastValue=null;a.internal.submitButtonClicked=!1;a.internal.hasAttemptedSubmit=!1;window.clearTimeout(a.internal.initialValidationHandle);a.internal.initialValidationHandle=window.setTimeout(function(){c(a)},249)}},h=function(a){return this.each(function(){var b={settings:d.extend({},
d.fn.evolutionValidation.defaults,a||{}),internal:{state:this,submitButtonClicked:!1,hasAttemptedSubmit:!1,fields:[],customValidations:[],initialValidationHandle:null,ignoreRevalidation:!1}};d(this).data("evolutionValidation",b);e(this,this);d(this).on("click",function(a){return s(b,a)});window.clearTimeout(b.internal.initialValidationHandle);b.internal.initialValidationHandle=window.setTimeout(function(){c(b)},499)})},e=function(a,b,c){a=d(a).closest("form");if(0<a.length){var e=null;a.off(".evolutionValidation").on("submit.evolutionValidation",
function(){if(null==e||10<(new Date).getTime()-e)return e=(new Date).getTime(),d(b).trigger("click"),!1})}},c=function(b){window.clearTimeout(b.internal.initialValidationHandle);try{var e=!1;if(!0===b.settings.validateOnLoad)e=!0;else if(!1!==b.settings.validateOnLoad)for(var f=0;f<b.internal.fields.length;f++){var g=d(b.internal.fields[f].selector),h=g.attr("type");if("checkbox"!=h&&"radio"!=h&&"select"!=h&&"submit"!=h&&"button"!=h&&"reset"!=h&&""!=n(g)){e=!0;break}}if(e)b.internal.hasAttemptedSubmit=
!0,a(b,function(){q(b)},!0);else if(!b.internal.hasAttemptedSubmit&&b.settings.onValidated)b.settings.onValidated(!0,!1,null)}catch(k){b.internal.initialValidationHandle=window.setTimeout(function(){c(b)},499)}},b=function(a){var b=!0;d.each(a.internal.fields,function(a,c){!1===c.isValid?!0===b&&(b=!1):null===c.isValid&&(b=null)});d.each(a.internal.customValidations,function(a,c){!1===c.isValid?!0===b&&(b=!1):null===c.isValid&&(b=null)});return!0===b},a=function(a,b,c){for(var e=!1,f=function(){if(e){var f=
null,g=!0;d.each(a.internal.fields,function(a,b){!1===b.isValid?!0===g&&(g=!1,f=b.context):null===b.isValid&&(g=null)});d.each(a.internal.customValidations,function(a,b){!1===b.isValid?!0===g&&(g=!1,f=b.context):null===b.isValid&&(g=null)});if(null!==g){if(c&&a.settings.onValidated)a.settings.onValidated(g,a.internal.submitButtonClicked,f);b&&b(g);return g}return!1}},g=0;g<a.internal.fields.length;g++)m(a,d(a.internal.fields[g].selector),f,!1);for(g=0;g<a.internal.customValidations.length;g++)p(a,
g,f,!1);e=!0;return f()},m=function(a,c,e,f){var g,h=n(c),k=c.data("evolutionValidation");if(null==k)return e(!0),!0;var m=h!=k.lastValue,l=function(){var c=!0;for(g=0;g<k.rules.length;g++){if(!1===k.rules[g].isValid){if(!1!==k.isValid){k.errorMessage=k.rules[g].message;k.isValid=!1;k.validationContext.internal.hasAttemptedSubmit&&d(k.messageSelector).html(k.errorMessage).show();if(f&&a.settings.onValidated)a.settings.onValidated(b(a),a.internal.submitButtonClicked,k.context);e&&e(!1)}return!1}null===
k.rules[g].isValid&&(c=!1)}if(c){k.errorMessage=null;k.isValid=!0;d(k.messageSelector).empty().hide();if(f&&a.settings.onValidated)a.settings.onValidated(b(a),a.internal.submitButtonClicked,null);e&&e(!0);return!0}return!1};d.each(k.rules,function(a,b){if(m||!b.cache)k.isValid=null,b.check(h,l)});k.lastValue=h;return l()},n=function(a){return"checkbox"==a.attr("type")||"radio"==a.attr("type")?a.get(0).checked?a.val():"":a.val()},p=function(a,c,e,f){if(0>c||c>=a.internal.customValidations.length)return e(!0),
!0;var g=a.internal.customValidations[c];g.isValid=null;var h=function(){if(!0===g.isValid){d(g.messageSelector).empty().hide();if(f&&a.settings.onValidated)a.settings.onValidated(b(a),a.internal.submitButtonClicked,g.context);e&&e(!0);return!0}if(!1===g.isValid){a.internal.hasAttemptedSubmit&&d(g.messageSelector).html(g.message).show();if(f&&a.settings.onValidated)a.settings.onValidated(b(a),a.internal.submitButtonClicked,null);e&&e(!1)}return!1};c=g.validationFunction();c.then?c.then(function(a){g.isValid=
!0===a;h()})["catch"](function(){g.isValid=!1;h()}):g.isValid=!0===c;return h()},s=function(b,c){var e=!b.internal.hasAttemptedSubmit;b.internal.hasAttemptedSubmit=!0;b.internal.submitButtonClicked=!0;var f=!1,h=!1,k=g,m=function(a){e&&!a&&q(b);if(f)a&&(b.internal.ignoreRevalidation=!0,d(b.internal.state).trigger("click"),b.internal.ignoreRevalidation=!1);else{var g=!0;a&&b.settings.onSuccessfulClick&&(g=b.settings.onSuccessfulClick(c));b.internal.submitButtonClicked=!1;k=a&&!1!==g;h=!0}};b.internal.ignoreRevalidation?
m(!0):a(b,m,!0);f=!0;!h&&c&&(c.cancelBubble=!0,k=c.returnValue=!1);return k},q=function(a){for(var b=0;b<a.internal.fields.length;b++)!1===a.internal.fields[b].isValid&&null!=a.internal.fields[b].errorMessage&&d(a.internal.fields[b].messageSelector).html(a.internal.fields[b].errorMessage).show();for(b=0;b<a.internal.customValidations.length;b++)!1===a.internal.customValidations[b].isValid&&d(a.internal.customValidations[b].messageSelector).html(a.internal.customValidations[b].message).show()},v=function(a){return null!=
a&&0<d.trim(a+"").length},t=function(a,b){b.get&&(b=b.get(0));var c=(b.nodeName||"").toLowerCase();return"input"!=c||!b.name||"radio"!=b.type.toLowerCase()&&"checkbox"!=b.type.toLowerCase()?"select"==c?d("option:selected",b).length:(a||"").length:d('input[name="'+b.name+'"]:checked').length},x=function(a,b){b=b||{};if("object"!==typeof b){var c=[];c[0]=b;b=c}return a.replace(/\{(\d+)\}/g,function(a,c){return b[c]||"?"})},w=function(a){return"function"!==typeof a?null:a};d.fn.evolutionValidation=function(a){if(a in
l)return l[a].apply(this,Array.prototype.slice.call(arguments,1));if("object"!==typeof a&&a)d.error("Method "+a+" does not exist on jQuery.fn.evolutionValidation");else return h.apply(this,arguments)};d.extend(d.fn.evolutionValidation,{defaults:{validateOnLoad:null,onValidated:null,onSuccessfulClick:null}});f.Telligent_Validation=function(a,b){this._jq=d(a);b.onValidatedFunction&&(b.onValidated=b.onValidatedFunction);b.onSuccessfulClickFunction&&(b.onSuccessfulClick=b.onSuccessfulClickFunction);this._jq.evolutionValidation(b)};
Telligent_Validation.prototype.AddField=function(a,b,c,d){this._jq.evolutionValidation("addField",a,b,c,d)};Telligent_Validation.prototype.AddCustomValidation=function(a,b,c,d,e){return this._jq.evolutionValidation("addCustomValidation",a,b,c,d,e)};Telligent_Validation.prototype.IsValid=function(){return this._jq.evolutionValidation("isValid")};Telligent_Validation.prototype.Validate=function(){return this._jq.evolutionValidation("validate")};Telligent_Validation.prototype.ValidateField=function(a){return this._jq.evolutionValidation("validateField",
a)};Telligent_Validation.prototype.ValidateCustom=function(a){return this._jq.evolutionValidation("validateCustom",a)};return{}},jQuery,window);p("plugin.evolutionVote",function(d,f,g){var k=function(a,b,c){if(a.internal.isInitialized&&!a.settings.isReadOnly)if(a.internal.userVote=c,a.settings.allowMultipleSelections||(a.settings.isReadOnly=!0),a.internal.savingValue=!0,null===b||0==c)a.settings.onDeleteVote();else a.settings.onVote(b,c)},l=function(a){var b=parseInt(a);return isNaN(b)?!0===a||"true"==
a?1:!1===a||"false"==a?-1:0:b},h=function(a){return this.each(function(){a&&a.userVote!=g&&(a.userVote=l(a.userVote));var b={settings:d.extend({},d.fn.evolutionUpDownVoting.defaults,a||{}),internal:{state:d(this)}};d(this).data("evolutionUpDownVoting_context",b);b.internal.state.addClass(b.settings.voteClass).css("white-space","nowrap").find("a").off(".evolutionUpDownVoting").empty().end();b.internal.state.empty();"true"==b.settings.userVote?b.settings.userVote=!0:"false"==b.settings.userVote&&(b.settings.userVote=
!1);b.settings.isReadOnly&&b.internal.state.addClass(b.settings.readOnlyClass);e(b,!0);var c="",f="neutral";0<b.settings.score?(f="positive",c=b.settings.positiveScoreModifier):0>b.settings.score&&(f="negative",c=b.settings.negativeScoreModifier);c='<div class="vote-score '+f+'">'+c+Math.abs(b.settings.score)+"</div>";b.settings.canViewVotes&&(c='<a class="ui-tip" title="'+b.settings.viewVotesMessage+'" href='+b.settings.voteUrl+">"+c+"</a>");b.internal.state.append('<div class="score-summary">'+
c+"</div>");e(b,!1)})},e=function(a,b){(function(){if(!a.settings.isUserRegistered||!a.settings.isUserGroupMember||!1!=b||a.settings.canUserDownVote)if(!a.settings.isUserRegistered||!a.settings.isUserGroupMember||!0!=b||a.settings.canUserUpVote){var e,f="",f=c(a,b);e=!a.settings.isUserRegistered||!0==b&&a.settings.canUserUpVote||!1==b&&a.settings.canUserDownVote?d('<a href="#" >'+f+"</a>").css({textDecoration:"none"}).attr("title",f).addClass("votingenabled ui-tip"):d('<a disabled="disabled">'+f+
"</a>").addClass(a.settings.readOnlyClass).attr("title",f).addClass("votingdisabled ui-tip");e.addClass("vote");1==b?e.addClass("upvote"):e.addClass("downvote");if(!a.settings.isReadOnly)if(!a.settings.isUserRegistered)e.attr("href",a.settings.loginUrl);else if(!0==b&&a.settings.canUserUpVote||!1==b&&a.settings.canUserDownVote)if(a.settings.userVote&&0<a.settings.userVote==b)0<a.settings.userVote==b&&(e.data("rating-value",b).addClass("selected").on("click.evolutionUpDownVoting",function(c){a.settings.allowMultipleVotes?
(c=a.settings.userVote+(b?1:-1),k(a,e.data("rating-value"),c)):k(a,null,0);return!1}),1<Math.abs(a.settings.userVote)?(f=Math.abs(a.settings.userVote),9<f&&(f="9+"),e.addClass("multiple").append('<span class="multiple-value">'+f+"</span>")):e.removeClass("multiple"));else e.data("rating-value",b).on("click.evolutionUpDownVoting",function(c){c=b?1:-1;a.settings.allowMultipleVotes&&(c+=a.settings.userVote);k(a,e.data("rating-value"),c);return!1});a.internal.state.append(e)}})();a.internal.isInitialized=
!0},c=function(a,b){if(a.settings.isReadOnly)return a.settings.readOnlyMessage;if((!b||a.settings.canUserUpVote)&&(b||a.settings.canUserDownVote)||a.settings.isUserRegistered){if(b&&!a.settings.canUserUpVote||!b&&!a.settings.canUserDownVote)return a.settings.isUserGroupMember?a.settings.noPermissionMessage:a.settings.notGroupMemberMessage;if(0<a.settings.userVote&&b||0>a.settings.userVote&&!b)return a.settings.allowMultipleVotes?b?a.settings.voteUpAgainMessage:a.settings.voteDownAgainMessage:a.settings.deleteMessage;
...
d(this).data("evolutionUpDownVoting_context");null!=b&&(a.userVote&&(a.userVote=l(a.userVote)),b.settings=d.extend({},b.settings,a),h.apply(d(this),[b.settings]))});if("undefined"!==typeof a&&"undefined"!==typeof b)return this.each(function(){var c=d(this).data("evolutionUpDownVoting_context");null!=c&&("userVote"==a&&(b=l(b)),c.settings[a]=b,h.apply(d(this),[c.settings]))});if("undefined"!==typeof a){var c=this.data("evolutionUpDownVoting_context");return null!==c?c.settings[a]:null}}};d.fn.evolutionUpDownVoting=
function(a){if(a in b)return b[a].apply(this,Array.prototype.slice.call(arguments,1));if("object"!==typeof a&&a)d.error("Method "+a+" does not exist on jQuery.fn.evolutionUpDownVoting");else return h.apply(this,arguments)};d.extend(d.fn.evolutionUpDownVoting,{defaults:{yesVotes:0,noVotes:0,voteCount:0,score:0,userVote:0,voteClass:"updownvote",overClass:"active",readOnlyClass:"readonly",isReadOnly:!1,allowMultipleSelections:!0,allowMultipleVotes:!1,canUserUpVote:!1,canUserDownVote:!1,canViewVotes:!1,
