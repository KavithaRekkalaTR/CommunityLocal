if (context_v2_propertyRule.Action == 'Execute') {
    ...
    if (url) {
        ...
        result = '<iframe src="' + url[1] + '" width="' + width + '" height="' + height + '" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
    }
